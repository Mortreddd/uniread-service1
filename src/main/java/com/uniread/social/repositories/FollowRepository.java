...
public interface FollowRepository extends JpaRepository<Follow, UUID> {
    ...
    @Query(value = """
        SELECT new com.uniread.social.dto.response.FollowUserDto(
            u.id,
            u.username,
            up.firstName,
            up.lastName,
        ...
        WHERE u.id IN (SELECT f.follower.id FROM Follow f WHERE f.following.id = :targetUserId)
        """,
            countQuery = """
    ...
    @Query(value = """
        SELECT new com.uniread.social.dto.response.AuthUserFollowDto(
            u.id,
            u.username,
